...
namespace App\Http\Controllers\API\Personnels;
    ...
    public function __invoke(Request $request): Collection
    {
        return Personnel::query()
            ...
            ->map(function (Personnel $personnel) {
                $personnel->nom_complet = $personnel->nom." ".$personnel->prenoms  ;
                $personnel->profile_image = route('avatar', $personnel->nom." ".$personnel->prenoms );
                return $personnel;
            });
    }
}
