...
namespace App\Http\Livewire\Evaluation\Devoir\Vue;
...
class ListeDevoir extends Component
{
    use WithPagination;
    public $per_page = 20 ;
    ...
    */
    ...
    {   
        $data = Devoir::where('annee_academique_id',$this->annee->id)->orderByDesc('created_at') ;
        ...
        return view('livewire.evaluation.devoir.vue.liste-devoir', ['devoirs' => $data]);
    }
}
