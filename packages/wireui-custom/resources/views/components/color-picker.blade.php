<div x-data="wireui_color_picker({
            ...
            <div class="absolute inset-y-0 right-0 flex items-center p-0.5">
                <x-dynamic-component
                    ...
                    <x-dynamic-component
                        ...
                        class="
                            w-4 h-4 group-focus:text-wire_primary-700 text-gray-400 dark:text-gray-600
                            dark:group-hover:text-gray-500 dark:group-focus:text-wire_primary-500
                        "
                        :name="$rightIcon"
                    />
                </x-dynamic-component>
    ...
    <x-wireui::parts.popover
        ...
        class="
            ...
            overflow-y-auto soft-scrollbar border border-wire_secondary-200
        ">
        <div class="flex flex-wrap items-center justify-center gap-1 sm:gap-0.5 max-w-[18rem] mx-auto">
            ...
            <template x-for="(color, index) in colors" :key="index">
                <button class="
                        ...
                        hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-wire_primary-600 sdark:focus:ring-gray-400
