...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        wire_primary: colors.indigo,
        wire_secondary: colors.slate,
        wire_positive: colors.emerald,
        wire_negative: colors.red,
        wire_warning: colors.amber,
        wire_info: colors.blue
      },
      fontSize: {
        '3xs': '0.5rem',
        '2xs': '0.65rem'
