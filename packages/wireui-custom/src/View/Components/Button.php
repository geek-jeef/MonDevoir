...
class Button extends BaseButton
{
    public function outlineColors(): array
    {
        return [
            ...
            'primary' => <<<EOT
                ring-wire_primary-500 text-wire_primary-500 border border-wire_primary-500 hover:bg-wire_primary-50
                dark:ring-offset-slate-800 dark:hover:bg-slate-700
            EOT,

            'secondary' => <<<EOT
                ring-wire_secondary-600 text-wire_secondary-600 border border-wire_secondary-600 hover:bg-wire_secondary-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:border-wire_secondary-400 dark:text-wire_secondary-400
            EOT,

            'positive' => <<<EOT
                ring-wire_positive-500 text-wire_positive-500 border border-wire_positive-500 hover:bg-wire_positive-50
                dark:ring-offset-slate-800 dark:hover:bg-slate-700
            EOT,

            'negative' => <<<EOT
                ring-wire_negative-500 text-wire_negative-500 border border-wire_negative-500 hover:bg-wire_negative-50
                dark:ring-offset-slate-800 dark:hover:bg-slate-700
            EOT,

            'warning' => <<<EOT
                ring-wire_warning-600 text-wire_warning-600 border border-wire_warning-600 hover:bg-wire_warning-50
                dark:ring-offset-slate-800 dark:hover:bg-slate-700
            EOT,

            'info' => <<<EOT
                ring-wire_info-600 text-wire_info-600 border border-wire_info-600 hover:bg-wire_info-50
                dark:ring-offset-slate-800 dark:hover:bg-slate-700
            EOT,
    ...
    public function flatColors(): array
    {
        return [
            ...
            'primary' => <<<EOT
                ring-wire_primary-600 text-wire_primary-600 hover:bg-wire_primary-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_primary-700
            EOT,

            'secondary' => <<<EOT
                ring-wire_secondary-600 text-wire_secondary-600 hover:bg-wire_secondary-100 dark:text-wire_secondary-400
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_secondary-700
            EOT,

            'positive' => <<<EOT
                ring-wire_positive-500 text-wire_positive-600 hover:bg-wire_positive-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_positive-700
            EOT,

            'negative' => <<<EOT
                ring-wire_negative-600 text-wire_negative-600 hover:bg-wire_negative-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_negative-700
            EOT,

            'warning' => <<<EOT
                ring-wire_warning-500 text-wire_warning-600 hover:bg-wire_warning-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_warning-700
            EOT,

            'info' => <<<EOT
                ring-wire_info-600 text-wire_info-600 hover:bg-wire_info-100
                dark:ring-offset-slate-800 dark:hover:bg-slate-700 dark:ring-wire_info-700
            EOT,
    ...
    public function defaultColors(): array
    {
        return [
            ...
            'primary' => <<<EOT
                ring-wire_primary-500 text-white bg-wire_primary-500 hover:bg-wire_primary-600 hover:ring-wire_primary-600
                dark:ring-offset-slate-800 dark:bg-wire_primary-700 dark:ring-wire_primary-700
                dark:hover:bg-wire_primary-600 dark:hover:ring-wire_primary-600
            EOT,

            'secondary' => <<<EOT
                ring-wire_secondary-500 text-white bg-wire_secondary-500 hover:bg-wire_secondary-600 hover:ring-wire_secondary-600
                dark:ring-offset-slate-800 dark:bg-wire_secondary-700 dark:ring-wire_secondary-700
                dark:hover:bg-wire_secondary-600 dark:hover:ring-wire_secondary-600
            EOT,

            'positive' => <<<EOT
                ring-wire_positive-500 text-white bg-wire_positive-500 hover:bg-wire_positive-600 hover:ring-wire_positive-600
                dark:ring-offset-slate-800 dark:bg-wire_positive-700 dark:ring-wire_positive-700
                dark:hover:bg-wire_positive-600 dark:hover:ring-wire_positive-600
            EOT,

            'negative' => <<<EOT
                ring-wire_negative-500 text-white bg-wire_negative-500 hover:bg-wire_negative-600 hover:ring-wire_negative-600
                dark:ring-offset-slate-800 dark:bg-wire_negative-700 dark:ring-wire_negative-700
                dark:hover:bg-wire_negative-600 dark:hover:ring-wire_negative-600
            EOT,

            'warning' => <<<EOT
                ring-wire_warning-500 text-white bg-wire_warning-500 hover:bg-wire_warning-600 hover:ring-wire_warning-600
                dark:ring-offset-slate-800 dark:bg-wire_warning-700 dark:ring-wire_warning-700
                dark:hover:bg-wire_warning-600 dark:hover:ring-wire_warning-600
            EOT,

            'info' => <<<EOT
                ring-wire_info-500 text-white bg-wire_info-500 hover:bg-wire_info-600 hover:ring-wire_info-600
                dark:ring-offset-slate-800 dark:bg-wire_info-700 dark:ring-wire_info-700
                dark:hover:bg-wire_info-600 dark:hover:ring-wire_info-600
            EOT,
