...
class Toggle extends Checkbox
{
        ...
        ")->unless(
            ...
            function (Stringable $stringable) {
                return $stringable->append('
                    bg-wire_secondary-200 peer-checked:bg-wire_primary-600 peer-focus:ring-wire_primary-600
                    group-focus:ring-wire_primary-600 dark:group-focus:ring-wire_secondary-600
                    dark:peer-focus:ring-wire_secondary-600 dark:peer-focus:ring-offset-wire_secondary-800
                    dark:bg-wire_secondary-600 dark:peer-checked:bg-wire_secondary-700
                ');
            },
            function (Stringable $stringable) {
                return $stringable->append('
                    bg-wire_negative-600 peer-focus:ring-wire_negative-600 dark:bg-wire_negative-700
                    group-focus:ring-wire_negative-600 dark:group-focus:ring-wire_negative-700
                    dark:peer-focus:ring-wire_negative-700 dark:peer-focus:ring-offset-wire_secondary-800
                ');
            }
        );
    }
    ...
    public function circleClasses(): string
    {
        ...
        return "
            ...
            checked:text-white dark:bg-wire_secondary-200
        ";
    }
}
