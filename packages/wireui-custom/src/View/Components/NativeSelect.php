...
class NativeSelect extends FormComponent
{
    ...
    public function defaultClasses(): string
    {
        return 'form-select block w-full pl-3 pr-10 py-2 text-base sm:text-sm shadow-sm
                ...
                dark:bg-wire_secondary-800 dark:border-wire_secondary-600 dark:text-wire_secondary-400';
    }

    public function colorClasses(): string
    {
        return 'border-wire_secondary-300 focus:ring-wire_primary-500 focus:border-wire_primary-500';
    }

    public function errorClasses(): string
    {
        return 'border-wire_negative-400 focus:ring-wire_negative-500 focus:border-wire_negative-500 text-wire_negative-500
                dark:border-wire_negative-600 dark:text-wire_negative-500';
    }
