<section >
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8 print:hidden">
    <h2 class="text-lg font-medium mr-auto">Emploi Du Temps Enseignant </h2>
  ...
  <div class="grid grid-cols-12 gap-5 mt-5 print:hidden">
    <div class="col-span-12 xl:col-span-12 2xl:col-span-12">
      <div class="box p-2">
        <livewire:widget.picker.enseignant-picker eventToFired="onChangementEnseignantForPlanning" />
      </div>
    </div>
  </div>
  <style type="text/css">
    #planningEnseignantTable .fc-event{
      border-color: rgb(var(--color-primary));
      background-color: rgb(var(--color-primary));
    }
    #planningEnseignantTable .fc-event-main{
      font-weight: 600;
      color: white;
    }
    #planningEnseignantTable table{
      border-width: 2px;
    }
    @media print {
      #planningEnseignantTable > div.fc-header-toolbar.fc-toolbar.fc-toolbar-ltr {
        display: none;
        margin: 0px;
        padding: 0px;
        width: 0px;
    ...
    <div class="mt-5 print:mt-0 print:p-5 print:shadow-none" style="width:29.6cm">
      <div class="print:p-0 print:m-0">
        ...
        <div wire:ignore class="box p-5 print:p-0 print:my-2 print:shadow-none">
          <div class="full-calendar" id="planningEnseignantTable"></div>
        </div>
        <x-print.page-footer />
      </div>
    </div>
  ...
  <script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function(event){
      (function () {
        if ($("#planningEnseignantTable").length) {
          ...
          let planningEnseignantTable = new Calendar($("#planningEnseignantTable")[0], options );

          planningEnseignantTable.render();

         

          window.addEventListener('onChangementEnseignantForPlanningBrowser', event => {
              console.log('onChangementEnseignantForPlanningBrowser: ');
              planningEnseignantTable.setOption('events', event.detail);
          });
