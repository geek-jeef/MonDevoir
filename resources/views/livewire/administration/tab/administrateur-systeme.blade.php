<div>
    <h2 class="intro-y text-lg font-medium mt-10">Administrateur Système</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <button class="btn btn-outline-secondary relative justify-start rounded-full pr-12" data-tw-toggle="modal" data-tw-target="#button-add-admin">
            ...
            <div id="button-add-admin" class="modal modal-slide-over" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
