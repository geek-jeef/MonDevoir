<div wire:init="loadData" class="col-span-12 sm:col-span-6 lg:col-span-4 mt-8">
                      <div class="intro-y flex items-center h-10">
                          <h2 class="text-lg font-medium truncate mr-5">Repartition des Eleves</h2>
                      ...
                      <div class="intro-y box py-2 mt-5">
                          <canvas wire:ignore class="my-2 w-full" height="300" id="repartition-eleve-chart" ></canvas>
                      </div>
  <script wire:ignore type="text/javascript">
    function initGrapheRepartitionEleve(selector,info) {
      if ($(selector).length) {
    ...
    document.addEventListener("GrapheRepartitionEleveLoadData", function(event) { 
      initGrapheRepartitionEleve("#repartition-eleve-chart",event.detail);
    });
  </script>
</div>