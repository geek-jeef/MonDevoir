<section>
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
            <a href="javascript:;" class="btn btn-outline-primary relative justify-start rounded-full pr-12 " data-tw-toggle="modal" data-tw-target="#formulaire-creation-examen"> Créer Un Nouvel Examen
    ...
    <livewire:evaluation.examen.vue.liste-examen />
    <div id="formulaire-creation-examen" class="modal modal-slide-over" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-header">
                  <h2 class="font-medium text-base mr-auto">Enregistrer un Examen</h2>
              </div>
              <div class="modal-body">
                <livewire:forms.examen.create-examen-form />
              </div>
  ...
  <div id="modal-show-examen" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2 class="font-medium text-base mr-auto">Examen</h2>
        </div>
