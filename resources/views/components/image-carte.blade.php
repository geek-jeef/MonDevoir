...
<div 
  ...
  <div x-show="!showCroppie && !hasImage" wire:ignore>
    <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
      <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
        @if($eleve->photo)
          <img  src="{{$eleve->photo->original_url}}" class="rounded-md aspect-[2/3] text-primary" />
        @else
          <x-icon name="user" class="rounded-md aspect-[2/3] text-primary" />
        @endif     
      </div>
      ...
      <div class="modal-dialog" style="margin: 0px;width: 100%">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mx-auto">
              <img src alt x-ref="croppie" class="display-block w-full">
            </div>
  ...
  <div x-show="!showCroppie && hasImage">
    <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
      <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto"  wire:ignore>
        <img src alt x-ref="result" class="rounded-md aspect-[2/3]">
